  ...
  return (
    <div className="w-full">
      <div className="relative group">
        <div
          className={`absolute -inset-0.5 bg-gradient-to-r ${colorGradient} rounded-lg blur opacity-30 group-hover:opacity-75 transition duration-1000`}
        />
        ...
        <div className="relative bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-gray-700 transition-all duration-300">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl font-bold text-accent-400">{company}</h3>
              </div>
          ...
          <button
            ...
            className="mt-4 flex items-center gap-2 text-accent-400 hover:text-accent-300 transition-colors"
          >
            {isExpanded ? (
              <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {environment.map((tech, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 rounded-full text-sm bg-accent-500/10 text-accent-400 hover:bg-accent-500/20 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
