...
const Experience = () => {
  ...
  const experiences = [
    ...
    // Première expérience (Servier)
    {
      ...
      description:
        "Dans une équipe de 6 DataOps au sein d'une dataFactory, prise en charge de l'optimisation du monitoring sur Google Cloud Platform (GCP) et rattachement des alertes sur ServiceNow.",
      achievements: [
    ...
    // Deuxième expérience (Carrefour)
    {
      ...
      description:
        "Release Manager / Prendre en charge l'architecture (OPS) et le CI/CD dans une équipe AGILE de 4 Développeurs, 1 productOwner, 1 testeur QA et 1 ScrumMaster",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Chef de projet technique dans une équipe de 20 personnes au sein de l'entité IPS/FGAT. Mise en production d'une dizaines d'applications (durée d'un projet : de 3 à 6 mois)",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Chef d'équipe adjoint de l'équipe Problème constituée de 4 personnes. Responsable du run et du maintien en conditions opérationnelles des applications en production.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Pour finir mon contrat pro, j'ai été placé au sein de la cellule informatique d'Umanis à temps plein 1 mois.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Apprenti Ingénieur Réseau au sein de l'équipe Infrastructure Réseau et Backbone (IRB) de 15 personnes.",
      achievements: [
      ...
      environment: ["Cisco", "Juniper", "VLAN", "QFabric", "Excel"],
    },
    {
      ...
      description:
        "Analyste d'exploitation de support niveau 2 en environnement UNIX / Windows sur des applications des domaines BDDF et FGAT.",
      achievements: [
