  ...
  const cases: CaseStudy[] = [
    {
      ...
      context:
        "Migration d'un CRM critique depuis une infrastructure on-premise vers une architecture cloud hybride GCP/OCI",
      challenge:
        "Maintenir la continuité de service pendant la migration tout en gérant des contraintes de sécurité et de performance",
      solution:
        "Mise en place d'une stratégie de migration progressive avec une architecture hybride, utilisant Terraform pour l'IaC et une approche GitOps pour les déploiements",
      results: [
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {cases[activeCase].technologies.map((tech, index) => (
                <span
                  key={index}
                  className="px-3 py-1 rounded-full text-sm bg-accent-500/10 text-accent-400"
                >
                  {tech}
                </span>
              ))}
